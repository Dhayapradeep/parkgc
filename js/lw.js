...
/*
   ...
   accidentally leaves and returns.
*/
    ...
    try {
        ...
        */
        ...
        /*
           ==================================
           CRITICAL:
           USE EXISTING FIREBASE STATE
           ==================================

           We DO NOT create a question.
           We DO NOT reset round.
...
function startRoomListener() {
    ...
    onValue(
        ...
        function (snapshot) {
            ...
            /*
               If player was completely removed,
            ...
            */
            ...
            /*
               If they were temporarily marked
               as left, don't destroy game state.
            */
...
function setupEvents() {
    ...
    /*
       ...
       This button only takes the player
       back to the lobby page.

       It does NOT reset the Firebase game.
    */
...
function showRound() {
    ...
    /*
       ==================================
       USE QUESTION FROM FIREBASE
       ==================================

       This is what makes reconnecting
       safe.

       We NEVER select a new question.
    */
    ...
    /*
       Only reset UI when the actual
       round changes.

       Reconnecting to the same round
       does NOT clear the input state
       unnecessarily.
    */
    ...
    /*
       If this player already answered
       this round before disconnecting,
       keep the answer controls disabled.
    */

    if (
        Number(
            currentPlayer.lastAnsweredRound
        ) === roundIndex
    ) {
...
function updateTimer() {
    ...
    /*
       ==================================
       FIREBASE IS THE TIMER SOURCE
       ==================================

       If the host reconnects after 8
       seconds, the timer will show the
       remaining ~7 seconds.

       It will NOT restart at 15.
    */
            ...
            await runTransaction(
                ...
                function (room) {
                    ...
                    */
                    ...
                    /*
                       PLAYER TEMPORARILY LEFT?

                       Don't reject them just because
                       the UI was disconnected.

                       The player record remains.
                    */
            ...
            function (room) {
                ...
                */
                ...
                /*
                   ...
                   for easier Firebase inspection.

                   The actual game still reads
...
async function calculateFinalResults() {
    ...
    try {
        ...
        /*
           Whether this browser is the first
           one to calculate results or not,
           refresh currentRoom afterward.
        */
    ...
    /*
       Refresh Firebase state so this
       browser sees finalRank/finalReward.
    */
...
function renderFinalLeaderboard() {
    ...
    /*
       Refresh our player reference
       from current Firebase state.
    */
